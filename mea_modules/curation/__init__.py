...
SLAy (capsule `23 slay_propose_merges`) proposes merge GROUPS and stops --
...
coverage-weighted merge over `11 stitch_templates`' outputs, exact under
...
imports SpikeInterface. Capsule `24 dense_merge_apply` owns the disk/stream
